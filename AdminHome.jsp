...
<html>
    ...
    <body background="gambar/Admin.jpg">
        <table>
            <style>
                *{ 
                    margin:0;
                ...
                <tr>
                    <td><h4><a href="FirstServlet"> Kembali <<< </h4></td>
                </tr>
            </table>
            <table>
                <br><br><br><marquee style="font-size: 20px; font-family: snap ITC;color: cadetblue">Mahasiswa</marquee>
            <tr>            
